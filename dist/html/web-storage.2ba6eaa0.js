...
})({"92rQ3":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "85c5d2722ba6eaa0";
...
},{}],"flHPx":[function(require,module,exports) {
...
}; // если что то сохранено то распыляем его в наш обьект иначе при перезагрузке мы перезапишем наш обьект на пустой
//---возвращаем данные с локального хранилища-----------------------------
returnDataFromLocalStorage();
//------------------------------------------------------------------------
refs.form.addEventListener("submit", onSubmitPush);
refs.form.addEventListener("input", (0, _lodashThrottleDefault.default)(onFormInputsChange, 500));
...
},{}]},["92rQ3","flHPx"], "flHPx", "parcelRequirea42f")

//# sourceMappingURL=web-storage.2ba6eaa0.js.map
