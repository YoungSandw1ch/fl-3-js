...
})({"etfKv":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "8a90d592af595f10";
...
},{}],"bazIw":[function(require,module,exports) {
const refs = {
    fetchBtn: document.querySelector(".btn"),
    userList: document.querySelector(".user-list")
};
refs.fetchBtn.addEventListener("click", ()=>{
    onUsersFetch().then(createListMarkup).then(renderList).catch((error)=>console.log(error));
});
...
//# sourceMappingURL=07-ajax.af595f10.js.map
